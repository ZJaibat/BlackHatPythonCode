...
def proxy_handler(client_socket, remote_host, remote_port, reveived_first):
...
def server_loop(local_host, local_port, remote_host, remote_port, received_first):
    ...
    while True:
        ...
        proxy_thread = threading.Thread(target=proxy_handler, args=(client_socket, remote_host, remote_port, received_first))
        proxy_thread.start()
...
def main():
    ...
    received_first = sys.argv[5]

    if "True" in received_first:
        received_first = True
    else:
